...
const API_BASE_URL = process.env.NEXT_PUBLIC_MARAVIA_API_URL ?? null;
...
export const whatsappEmbeddedService = {
   ...
   */
  procesarToken: async (accessToken, eventType = 'FINISH', idPlataforma = null) => {
    try {
   ...
   */
  obtenerConfiguracion: async (idPlataforma = null) => {
    try {
   ...
   */
  desconectar: async (idPlataforma = null) => {
    try {
   ...
   */
  verificarEstado: async (idPlataforma = null) => {
    try {
   ...
   */
  suscribirWebhook: async (idPlataforma = null) => {
    try {
   ...
   */
  suscribirCoexistence: async (idPlataforma = null) => {
    try {
   ...
   */
  sincronizarSMB: async (idPlataforma = null, syncType = 'all') => {
    try {
