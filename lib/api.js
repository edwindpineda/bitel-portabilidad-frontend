...
export const API_BASE_URL = process.env.NEXT_PUBLIC_APP_BASE_URL || API_URL.replace(/\/api\/?$/, '');
...
api.interceptors.request.use(
  async (config) => {
    ...
    // Si es FormData, eliminar Content-Type para que axios establezca el boundary correcto
