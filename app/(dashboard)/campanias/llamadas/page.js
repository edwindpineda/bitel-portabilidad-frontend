        ...
        <Table>
          ...
          <TableBody>
            {filteredCampanias.map((campania) => (
              ...
              >
                <TableCell>
                  <Link href={`/campanias/llamadas/${campania.id}`} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                ...
                <TableCell>
                  <div className="flex items-center gap-1">
                    <Link href={`/campanias/llamadas/${campania.id}`}>
                      <Button
                        variant="ghost"
                        size="icon"
