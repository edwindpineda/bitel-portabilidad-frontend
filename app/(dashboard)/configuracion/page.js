...
export default function ConfiguracionPage() {
  ...
  // Grupo 3: Gestión de Llamada de Voz
  const gestionLlamadas = [
    {
      title: 'Formatos',
      description: 'Gestionar formatos de datos y campos',
      href: '/configuracion/formatos',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      title: 'Base de Números',
      description: 'Cargar y gestionar bases de números',
      href: '/configuracion/bases-numeros',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Plantillas',
      description: 'Gestionar plantillas de prompts para campañas',
  ...
  const ConfigCard = ({ config }) => (
    ...
    >
      <div className={`${config.color} w-12 h-12 rounded-lg flex items-center justify-center text-white mb-3`}>
        {config.icon}
      </div>
  ...
  const SectionHeader = ({ icon, title, description, gradient }) => (
    <div className={`rounded-lg p-4 mb-4 ${gradient}`}>
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
          {gestionUsuario.map((config) => (
            <ConfigCard key={config.href} config={config} />
          ))}
        </div>
      </div>

      {/* Sección: Gestión de Mensajes WhatsApp */}
      <div className="mb-8">
        <SectionHeader
          icon={
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {gestionWhatsApp.map((config) => (
            <ConfigCard key={config.href} config={config} />
          ))}
        </div>
      </div>

      {/* Sección: Gestión de Llamada de Voz */}
      <div className="mb-8">
        <SectionHeader
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
