...
export default function ConfiguracionPage() {
  const configuraciones = [
    ...
    {
      title: 'Equipos',
      description: 'Ver coordinadores y sus asesores',
      href: '/configuracion/equipos',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Gestionar FAQs de portabilidad',
    ...
    },
    {
      ...
      description: 'Gestionar tipificaciones de leads',
    ...
    },
    {
      ...
      description: 'Gestionar preguntas de perfilamiento',
      href: '/configuracion/preguntas-perfilamiento',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
    ...
    },
    {
      ...
      description: 'Gestionar argumentos de venta',
      href: '/configuracion/argumentos-venta',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Periodicidades Recordatorio',
      description: 'Configurar intervalos de recordatorios',
      href: '/configuracion/periodicidades-recordatorio',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
